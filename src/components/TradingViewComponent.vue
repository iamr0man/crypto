...
export default class TradingViewComponent extends Vue {
    ...
    bars:any = []
    ccStreamer:any = null
    allSubs:any = ["5~CCCAGG~BTC~USD", "5~CCCAGG~LTC~USD", "5~CCCAGG~NMC~USD", "5~CCCAGG~STC~USD", "5~CCCAGG~PPC~USD", "5~CCCAGG~EMC~USD", "5~CCCAGG~GRC~USD", "5~CCCAGG~XPM~USD", "5~CCCAGG~VTC~USD", "5~CCCAGG~ETH~USD", "5~CCCAGG~ETC~USD", "5~CCCAGG~WAVES~USD", "5~CCCAGG~ZEC~USD", "5~CCCAGG~BCH~USD", "24~CCCAGG~BTC~USD~m", "24~CCCAGG~LTC~USD~m", "24~CCCAGG~NMC~USD~m", "24~CCCAGG~STC~USD~m", "24~CCCAGG~PPC~USD~m", "24~CCCAGG~EMC~USD~m", "24~CCCAGG~GRC~USD~m", "24~CCCAGG~XPM~USD~m", "24~CCCAGG~VTC~USD~m", "24~CCCAGG~ETH~USD~m", "24~CCCAGG~ETC~USD~m", "24~CCCAGG~WAVES~USD~m", "24~CCCAGG~ZEC~USD~m", "24~CCCAGG~BCH~USD~m"]
    ...
    createData() {
        setInterval(() => {
            let data = store.getters.currentCryptoArray
    ...
    mounted() {
        ...
        const ccStreamer = new WebSocket('wss://streamer.cryptocompare.com/v2?api_key=df6e4e1e375a2a91508dff84acd2f0f0bccc6d3659f2a1fa2dfe94990b25b2dd')
        ...
        ccStreamer.onmessage = (event) => {
            ...
            store.commit('SET_CRYPTO_DATA', data)
        }
    }
